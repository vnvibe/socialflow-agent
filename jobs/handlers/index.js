...
const checkRepliesHandler = require('./check-replies')
...
// Vòng tìm & trả lời reply — CẦN browser của nick (không phải utility)
registry.register('check_replies', checkRepliesHandler, { label: 'Trả lời reply', icon: '💬' })
