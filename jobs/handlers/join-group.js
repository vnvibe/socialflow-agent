...
async function joinGroupHandler(payload, supabase) {
  const { account_id, fb_group_id, group_url, discovered_group_id, campaign_id } = payload || {}
  if (!account_id) throw new Error('account_id is required for joinGroupHandler')
