...
Chấm điểm 1-10:
- fluency: Tiếng Việt CÓ TRÔI CHẢY, ĐÚNG NGHĨA, đúng chính tả như người Việt viết không? Chấm THẤP (1-3) nếu có TỪ VÔ NGHĨA/SAI NGHĨA, cụm dịch máy sượng, danh từ riêng bị dịch/thêm chữ lạ, hoặc lẫn tiếng Anh sống sượng.
...
6. Viết 1-3 câu, ngắn gọn, có thể dùng viết tắt
...
9. Viết THUẦN TIẾNG VIỆT — thuật ngữ kỹ thuật (Docker, API, VPS, deploy...) giữ nguyên tiếng Anh, nhưng KHÔNG chèn từ tiếng Anh vụn kiểu "super helpful", "guys", "chapter", "nha bro", "tweak". Nói tự nhiên như người Việt.
...
11. VIẾT NGẮN, CHẮC, ĐÚNG NGỮ PHÁP. Thà 1 câu đơn giản đúng còn hơn 2 câu rối. Những lỗi ĐÃ TỪNG MẮC, tuyệt đối tránh:
...
12. TUYỆT ĐỐI KHÔNG nhắc tên tài khoản của chính mình trong comment (người thật không tự xưng tên ở ngôi thứ ba). Xưng "mình"/"em"/"tôi".
...
Chỉ trả về COMMENT, không giải thích.`
  try {
    ...
    const tokenLimit = (strategy === 'seed' || strategy === 'recommend') ? 160 : 120
