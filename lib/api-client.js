...
class ApiClient {
  constructor() {
    this.baseUrl = process.env.API_URL || _cfg.API_URL || 'https://103-142-24-60.sslip.io'
    // config.js uses AGENT_SECRET_KEY; env can use AGENT_SECRET or AGENT_SECRET_KEY
    this.agentSecret = process.env.AGENT_SECRET || process.env.AGENT_SECRET_KEY || _cfg.AGENT_SECRET_KEY || ''
    this.agentId = process.env.AGENT_ID || _cfg.AGENT_ID || AGENT_ID
