...
// ⚠️ Alias tương thích ngược. `supabase` ở ĐÂY và trong toàn bộ codebase KHÔNG phải
// Supabase — nó chỉ là bí danh của `db` (client PostgreSQL VPS trực tiếp / VPS API).
// Dự án ĐÃ BỎ Supabase. Mọi lời gọi `supabase.from(...)` thực chất chạy trên VPS Postgres.
const supabase = db
