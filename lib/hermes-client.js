...
const getApiUrl = () => {
  // KHÔNG rewrite sang http://103.142.24.60:3000 nữa.
  // Cổng 3000 chỉ nghe nội bộ trên VPS (Caddy proxy vào), từ ngoài luôn ECONNREFUSED.
  // Endpoint dùng được là HTTPS qua Caddy — đúng giá trị system_settings.api_config.api_url.
  return process.env.API_URL || process.env.API_BASE_URL || 'https://103-142-24-60.sslip.io'
}
